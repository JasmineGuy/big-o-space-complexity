...
// ANSWER: we can store less nonsense 
...
// ANSWER: 
// We settled on the idea that each function has an input that directly impact the memory necessary to run the function which make them both linear. 
// The return of each function is based on the size/length of the string passed in
...
let thisOne = new Another
// thisOne.addNumbers(3, 4)
/*
...
console.log(thisOne.addNumbers(3,4))
console.log(thisOne.addNumbers(5,4))
console.log(thisOne.addNumbers(6,4))
console.log(thisOne.addNumbers(4,4))
